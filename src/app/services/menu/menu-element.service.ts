...
export class MenuElementService {
  ...
  changeElementsOrderAdd(elements: MenuElement[], menuCategoryId: number): Promise<any> {
    return this.httpClient.post(API_URL + "/api/menu-category/add/elements/order/change", { elements, menuCategoryId }).toPromise()
  }

  freeElementFromMenuCategory(element: MenuElement): Promise<any> {
    return this.httpClient.post(API_URL + "/api/menu-element/free/from/menu-category", element).toPromise()
  }
  ...
  addElementToMenu(element: MenuElement, menuCategoryId: number): Promise<any> {
    return this.httpClient.post(API_URL + "/api/menu-category/add/element/to/menu", { element, menuCategoryId }).toPromise()
  }
